...
- **Умный анализ данных**: Автоматическое профилирование файлов (CSV, XML, Excel) с определением типов данных, временных полей и статистики
...
- **Поддержка форматов**: CSV, JSON[^1], XML[^1], Excel (XLSX, XLS)
...
[^1]: JSON возможна некоректаня обработка больших файлов
---
